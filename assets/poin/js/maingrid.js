            ...
            if (obj.UploadedFileName != null) {
                ...
                if (arrFileName[0] != '') {
                    for (var x = 0; x < arrFileName.length; x++) {
                        if (arrFileName[x] != '')
                            output += "<tr><td width=\"660\"><a href=\"" + UploadDirectory + Uri.EscapeDataString(arrFileName[x]) + "\" target=\"_new\" >" + arrFileName[x] + "</td><td><button type=\"button\" class=\"btn btn-danger btn-xs\" onClick=\"removefile('" + InitNumber + "','" + arrFileName[x] + "',this)\" >Remove</button></td></tr>";
...
function onUploadControlFileUploadComplete(s, e) {
    if (e.callbackData) {
        ...
        if (fileName != '')
            $("#summary-uploaded-files").append("<tr><td width='660'><a href=\"" + UploadDirectory + Uri.EscapeDataString(fileName) + "\" target=\"_new\">" + fileName + "</a></td><td><button type=\"button\" class=\"btn btn-danger btn-xs\" onClick=\"removefile('" + initiativenumber + "','" + fileName + "',this)\" >Remove</button></td></tr>");
